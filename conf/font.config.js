...
module.exports = {
  ...
  FONT_URL: process.env.NEXT_PUBLIC_FONT_URL || [
    // 霞鹜文楷 (LXGW WenKai)，与词元工作室 ciyuan-ai.fun 同款字体
    'https://cdn.jsdelivr.net/npm/@callmebill/lxgw-wenkai-web/style.css',
    // fastly 备用节点，国内访问更稳；与上方为同一版本，内容一致
    'https://fastly.jsdelivr.net/npm/@callmebill/lxgw-wenkai-web/style.css'
  ],
